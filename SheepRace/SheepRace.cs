...
namespace SheepRace
{
    public partial class SheepRace : Form
    {
        ...
        public void Punters()
        {
            ...
            myPunters[1].MyLabel = lblLovepannu;
            myPunters[1].MyRadioButton = rbLovepannu;
        ...
        public void BettorBroke() // Checks to see if anyone is broke and cannot continue and update label and blank out radio button
        {
            ...
            if (myPunters[1].Cash <= 0)//Lovepannu
            {
                lblLovepannu.Text = "Lovepannu is now broke and cannot continue betting";
                rbLovepannu.Enabled = false;
            }
        ...
        private void rbLovepannu_CheckedChanged(object sender, EventArgs e)
        {
            //Show that Lovepannu is betting in the bettor label
        ...
        private void btnRace_Click(object sender, EventArgs e)
        {
            ...
            if (myPunters[1].Cash < udBoxBet.Value && rbLovepannu.Enabled)
            {
                MessageBox.Show("Sorry but Lovepannu does not have enough cash to proceed.");
                timer1.Enabled = false;
            }
        ...
        public void btnLockIn_Click(object sender, EventArgs e) // Unlock the Race Button and check bet amount is not more than cash
        {
            try
            {
                ...
                {
                    MessageBox.Show("Lovepannu does not have enough to proceed");
                    btnRace.Enabled = false;
                }
